...
+ agent-config/logs/
+ agent-state/
+ .gitignore (matching the CodeCommit project .gitignore, imported via include_str!)
+ build.sh (matching the CodeCommit project build.sh, imported via include_str!)
+ Cargo.toml
+ src/
+ src/main.rs
