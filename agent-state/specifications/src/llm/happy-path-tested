...
the concatenated string to `response.txt`. If a terminal Interaction contains
no text outputs, treat it as an error and log the full Interaction JSON. The
field that contains the text is called "text".
